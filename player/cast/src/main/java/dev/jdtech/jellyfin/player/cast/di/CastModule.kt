...
abstract class CastModule {
    @Binds
    @Singleton
    abstract fun bindCastSessionManager(impl: CastSessionManagerImpl): CastSessionManager

    @Binds
    @Singleton
    abstract fun bindCastPlayerController(impl: CastPlayerControllerImpl): CastPlayerController
}
